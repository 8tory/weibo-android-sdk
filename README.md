...
* Step 3: Documentation: [Weibo-Android-SDK-v3.1.2.cn.pdf][1]
...
Details: [Weibo-Android-SDK-v3.1.2.cn.pdf][1]
...
2. For Eclipse, import WeiboSDKDemo project.(Details: [Weibo-Android-SDK-v3.1.2.cn.pdf][1])
3. For Android Studio, import WeiboSDKDemo project. (Details: [Weibo-Android-SDK-v3.1.2.cn.pdf][1])
...
Details: In **How to generate signature with Weibo official sign tool** chapter ,[Weibo-Android-SDK-v3.1.2.cn.pdf][1]
...
Details: In **Choose integration** chapter, [Weibo-Android-SDK-v3.1.2.cn.pdf][1]
...
[1]:https://github.com/8tory/weibo-android-sdk/releases/download/3.1.2/Weibo-Android-SDK-v3.1.2.cn.pdf
[2]:FAQ.cn.md
[3]:https://github.com/sinaweibosdk/weibo_android_sdk/blob/master/WeiboSDK_API-V2.4.0.CHM
[4]:https://github.com/8tory/weibo-android-sdk/releases/download/3.1.2/weibo-android-sdk-demo-debug.apk
